...
infile = '/root/autodl-tmp/mscoco/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv'    # 'data/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv'
train_data_file = '/root/autodl-tmp/train36.hdf5'   # 'data/train36.hdf5'
val_data_file = '/root/autodl-tmp/val36.hdf5'   # 'data/val36.hdf5'
train_indices_file = '/root/autodl-tmp/train36_imgid2idx.pkl'   # 'data/train36_imgid2idx.pkl'
val_indices_file = '/root/autodl-tmp/val36_imgid2idx.pkl'   # 'data/val36_imgid2idx.pkl'
train_ids_file = '/root/autodl-tmp/train_ids.pkl'   # 'data/train_ids.pkl'
val_ids_file = '/root/autodl-tmp/val_ids.pkl'   # 'data/val_ids.pkl'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = utils.load_imageid('/root/autodl-tmp/mscoco/train2014') # 'data/train2014'
        val_imgids = utils.load_imageid('/root/autodl-tmp/mscoco/val2014') # 'data/val2014'
